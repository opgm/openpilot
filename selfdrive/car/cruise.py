...
class VCruiseHelper:
  ...
  def initialize_v_cruise(self, CS, experimental_mode: bool, resume_prev_button: bool) -> None:
    ...
    if any(b.type in (ButtonType.accelCruise, ButtonType.resumeCruise) for b in CS.buttonEvents) and self.v_cruise_initialized or (self.gm_cc_only and resume_prev_button):
