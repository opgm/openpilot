...
def main() -> None:
  ...
  while not do_exit:
    try:
      ...
      # Newer params schemas may not define PandaSignatures.
      # Keep startup resilient across schema/version combinations.
      try:
      ...
      # log panda fw version when key exists in this params schema
      try:
