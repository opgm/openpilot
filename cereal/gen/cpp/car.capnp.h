...
struct CarState {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(9da4fa09e052903c, 9, 6)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand() { return &schema->defaultBrand; }
    #endif  // !CAPNP_LITE
  };
...
inline bool CarState::Reader::getCanRcvTimeout() const {
  return _reader.getDataField<bool>(
      ::capnp::bounded<363>() * ::capnp::ELEMENTS);
}

inline bool CarState::Builder::getCanRcvTimeout() {
  return _builder.getDataField<bool>(
      ::capnp::bounded<363>() * ::capnp::ELEMENTS);
}
inline void CarState::Builder::setCanRcvTimeout(bool value) {
  _builder.setDataField<bool>(
